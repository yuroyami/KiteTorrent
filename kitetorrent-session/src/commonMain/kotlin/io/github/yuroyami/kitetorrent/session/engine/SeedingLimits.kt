...
/**
 * The pure "stop seeding?" decision — the port of libtorrent's share-ratio / seed-time
 * limit checks (`session_impl::recalculate_auto_managed_torrents`,
...
object SeedingLimits {
     ...
     * @param totalSize the torrent's size — the floor for the ratio denominator, so a
